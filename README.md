...
VALUES(1, '노예모집중', '삼성전자링', NULL, 20221030, '백엔드개발', '사원', 'java 코딩', '회사 내규에 따름', '대졸', '신입', '전자레인지 있음, 커피 제공', 2);
INSERT INTO notice(company_id, notice_title, notice_coname, notice_image, notice_period, notice_dept, notice_position, notice_task, notice_sal, notice_qual, notice_career, notice_wellfare, job_id)
VALUES(2, '프론트엔드 개발자 모집합니다.', '보성엔진' , NULL, 20221030, '프론트엔드개발', '사원', 'html 코딩', '회사 내규에 따름', '대졸', '신입', '전자레인지 있음, 커피 제공', 1);
INSERT INTO notice(company_id, notice_title, notice_coname, notice_image, notice_period, notice_dept, notice_position, notice_task, notice_sal, notice_qual, notice_career, notice_wellfare, job_id)
VALUES(3,'flutter 풀스택 개발자 모집합니다.', 'LG전자', NULL, 20221030, '풀스택개발', '사원', 'flutter 코딩', '3600만원', '고졸', '3년', '경조사비 제공, 분기별 보너스 지급', 3);
